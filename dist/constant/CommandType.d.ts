export declare enum CommandType {
     ...
     */
    COMM_CHECK_ADMIN = 65,// 'A'
    /**
     * Administrator keyboard password
     */
    COMM_SET_ADMIN_KEYBOARD_PWD = 83,// 'S'
    /**
     * Delete password
     */
    COMM_SET_DELETE_PWD = 68,// 'D'
    /**
     * Set the lock name
     */
    COMM_SET_LOCK_NAME = 78,// 'N'
    /**
     * Sync keyboard password
     */
    COMM_SYN_KEYBOARD_PWD = 73,// 'I'
    /**
     * Verify user time
     */
    COMM_CHECK_USER_TIME = 85,// 'U'
    /**
     ...
     */
    COMM_GET_ALARM_ERRCORD_OR_OPERATION_FINISHED = 87,// 'W'
    /**
     * Open the door
     */
    COMM_UNLOCK = 71,// 'G'
    ...
    COMM_CYCLIC_CMD = 112,
    /**
     * Unlock direction (handle rotation side) — requires FeatureValue.UNLOCK_DIRECTION
     */
    COMM_UNLOCK_DIRECTION = 113,
    /**
