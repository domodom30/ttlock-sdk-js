...
const log = (0, logger_1.createLogger)('ttlock:comm');
...
class CommandEnvelope {
    ...
    static createFromRawData(rawData, aesKey) {
        ...
        // check CRC
        const crc = CodecUtils_1.CodecUtils.crccompute(rawData.subarray(0, rawData.length - 1));
     ...
     */
    generateCommand() {
        if (this.commandType != CommandType_1.CommandType.COMM_UNSET && this.command == undefined) {
