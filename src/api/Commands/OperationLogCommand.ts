...
const logger = createLogger('ttlock:command');
      ...
      if (totalLen > 0) {
        ...
        while (index < this.commandData.length) {
          ...
          switch (log.recordType) {
            ...
            case LogOperate.LOW_BATTERY_ALARM:
            case LogOperate.DOOR_NOT_LOCKED_ALARM:
            case LogOperate.DOOR_OPENED_ALARM:
            case LogOperate.DOOR_SENSOR_ANOMALY:
            case LogOperate.KEYBOARD_LOCKED:
            case LogOperate.RESET_BUTTON:
